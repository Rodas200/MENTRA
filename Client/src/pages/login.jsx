      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h1 className="text-white text-4xl font-black text-center mb-1 -mt-8" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
              Welcome back..
            </h1>
            <p className="text-center text-sm mb-8" style={{ color: "#8a9ab5" }}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs hover:underline" style={{ color: "#7b6ff0" }}>
                    Forgot password?
                  </a>
                </div>
